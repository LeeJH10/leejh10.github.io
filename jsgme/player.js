function setChannels(){
    ...
    if($("#ch9").attr("checked")!="checked")mask+=0x100;
		if($("#ch10").attr("checked")!="checked")mask+=0x200;
		if($("#ch11").attr("checked")!="checked")mask+=0x400;
		if($("#ch12").attr("checked")!="checked")mask+=0x800;
		if($("#ch13").attr("checked")!="checked")mask+=0x1000;
		//message(mask);
